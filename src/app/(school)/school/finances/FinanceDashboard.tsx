...
export function FinanceDashboard({
  ...
  return (
    <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {tab === "echeances" && <InstallmentsTab templates={templates} students={overview.students} />}
...
function InstallmentsTab({ templates, students }: { templates: InstallmentTemplate[]; students: FinanceStudentRow[] }) {
  return (
...
<table><thead><tr><th>Rubrique</th><th class="r">Montant</th><th class="r">Date</th></tr></thead><tbody><tr><td>${escHtml(rubrique)}</td><td class="r">${money(inv.amount, inv.currency)}</td><td class="r">${escHtml(dateFr)}</td></tr></tbody></table>
<div class="sig"><div><div class="lbl">Cachet &amp; signature (direction)</div><div style="height:50px"></div><div style="border-bottom:1px solid #1a1410"></div></div><div style="text-align:right"><div class="lbl">Reçu par le parent</div><div style="height:50px"></div><div style="border-bottom:1px solid #1a1410"></div></div></div>
